...
describe("TamboRegistryProvider", () => {
    ...
    describe("Resource registration", () => {
        it("should register static resources via props", () => {
            ...
            const wrapper = ({ children }) => (React.createElement(TamboRegistryProvider, { resources: staticResources }, children));
            const { result } = renderHook(() => useTamboRegistry(), { wrapper });
        ...
        it("should register resource source via props", () => {
            ...
            const wrapper = ({ children }) => (React.createElement(TamboRegistryProvider, { listResources: mockListResources, getResource: mockGetResource }, children));
            const { result } = renderHook(() => useTamboRegistry(), { wrapper });
        ...
        it("should throw error when only listResources is provided", () => {
            const mockListResources = jest.fn().mockResolvedValue([]);
            expect(() => {
                const wrapper = ({ children }) => (React.createElement(TamboRegistryProvider, { listResources: mockListResources }, children));
        ...
        it("should throw error when only getResource is provided", () => {
            ...
            expect(() => {
                const wrapper = ({ children }) => (React.createElement(TamboRegistryProvider, { getResource: mockGetResource }, children));
                renderHook(() => useTamboRegistry(), { wrapper });
            }).toThrow("Both listResources and getResource must be provided together");
        });
