...
const TamboStubThreadProvider = ({ children, ...threadContextProps }) => {
    ...
    return (React.createElement(TamboThreadContext.Provider, { value: threadContextProps },
        React.createElement(TamboGenerationStageProvider, { generationStage: generationStage, statusMessage: statusMessage }, children)));
};
/**
...
export const TamboStubProvider = ({ children, thread, components = [], tools = [], threads, projectId, contextKey, contextHelpers, ...overrides }) => {
    ...
    return (React.createElement(TamboStubClientProvider, { client: stubClient, queryClient: stubQueryClient, threads: threads, projectId: resolvedProjectId, contextKey: contextKey, isUpdatingToken: false },
