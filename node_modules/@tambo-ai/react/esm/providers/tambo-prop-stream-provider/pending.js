...
import { DEFAULT_STREAM_KEY } from "./types";
/**
 ...
 */
export const Pending = ({ streamKey = DEFAULT_STREAM_KEY, children, className, }) => {
    ...
    return (React.createElement("div", { className: className, "data-stream-key": streamKey, "data-stream-state": "pending" }, children));
};
