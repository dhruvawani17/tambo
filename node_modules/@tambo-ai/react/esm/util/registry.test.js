...
describe("getComponentFromRegistry", () => {
    ...
    it("should throw error when component not found", () => {
        expect(() => getComponentFromRegistry("NonExistent", mockRegistry)).toThrow("Tambo tried to use Component NonExistent, but it was not found");
    });
    it("should be case-sensitive for component names", () => {
        expect(() => getComponentFromRegistry("testcomponent", mockRegistry)).toThrow("Tambo tried to use Component testcomponent, but it was not found");
    });
});
describe("getAvailableComponents", () => {
    ...
    it("should return available components with no tools when no associations", () => {
        const associations = {};
        const result = getAvailableComponents(mockRegistry, mockToolRegistry, associations);
