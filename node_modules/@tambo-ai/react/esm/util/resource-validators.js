 ...
 */
export function validateResourceSource(listResources, getResource) {
    const hasListResources = listResources != null;
    const hasGetResource = getResource != null;
    if (hasListResources !== hasGetResource) {
        throw new Error("Both listResources and getResource must be provided together, or neither should be provided. " +
