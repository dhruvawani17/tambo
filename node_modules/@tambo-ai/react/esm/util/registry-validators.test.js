...
describe("validateTool", () => {
    ...
    it("should throw when tool name contains invalid characters", () => {
        ...
        expect(() => validateTool(tool)).toThrow('tool "invalid tool name" must only contain letters, numbers, underscores, and hyphens.');
    });
    it("should throw when tool name contains special characters", () => {
        ...
        expect(() => validateTool(tool)).toThrow('tool "tool@name" must only contain letters, numbers, underscores, and hyphens.');
    });
    it("should throw when deprecated toolSchema is used", () => {
        ...
        expect(() => validateTool(tool)).toThrow('Tool "deprecated-tool" uses deprecated "toolSchema" property.');
        expect(() => validateTool(tool)).toThrow('Migrate to "inputSchema" and "outputSchema" properties.');
    });
    ...
    it("should throw when tool name is missing", () => {
        ...
        expect(() => validateTool(tool)).toThrow("Tool must have a 'name' property of type string");
    });
    it("should throw when tool description is missing", () => {
        ...
        expect(() => validateTool(tool)).toThrow("Tool \"my-tool\" must have a 'description' property of type string");
    });
    it("should throw when tool function is missing", () => {
        ...
        expect(() => validateTool(tool)).toThrow("Tool \"my-tool\" must have a 'tool' property of type function");
    });
    it("should throw when inputSchema is missing", () => {
        ...
        expect(() => validateTool(tool)).toThrow("Tool \"my-tool\" must have an 'inputSchema' property");
    });
    it("should throw when outputSchema is missing", () => {
        ...
        expect(() => validateTool(tool)).toThrow("Tool \"my-tool\" must have an 'outputSchema' property");
    });
    it("should throw when inputSchema contains z.record()", () => {
        ...
        expect(() => validateTool(tool)).toThrow('Record types (objects with dynamic keys) are not supported in inputSchema of tool "invalid-tool".');
    });
...
describe("validateAndPrepareComponent", () => {
    ...
    it("should throw when component name contains invalid characters", () => {
        ...
        expect(() => validateAndPrepareComponent(component)).toThrow('component "invalid component name" must only contain letters, numbers, underscores, and hyphens.');
    });
    it("should throw when neither propsSchema nor propsDefinition is provided", () => {
        ...
        expect(() => validateAndPrepareComponent(component)).toThrow("Component component-without-props must have either propsSchema (recommended) or propsDefinition defined");
    });
    it("should throw when both propsSchema and propsDefinition are provided", () => {
        ...
        expect(() => validateAndPrepareComponent(component)).toThrow("Component component-with-both cannot have both propsSchema and propsDefinition defined. Use only one. We recommend using propsSchema.");
    });
    it("should throw when propsSchema contains z.record()", () => {
        ...
        expect(() => validateAndPrepareComponent(component)).toThrow('Record types (objects with dynamic keys) are not supported in propsSchema of component "component-with-record".');
    });
...
describe("validateToolAssociation", () => {
    it("should validate valid tool association", () => {
        expect(() => validateToolAssociation("valid-component", "valid-tool", true, true)).not.toThrow();
    });
    it("should throw when component name is invalid", () => {
        expect(() => validateToolAssociation("invalid component", "valid-tool", true, true)).toThrow('component "invalid component" must only contain letters, numbers, underscores, and hyphens.');
    });
    it("should throw when tool name is invalid", () => {
        expect(() => validateToolAssociation("valid-component", "invalid tool", true, true)).toThrow('tool "invalid tool" must only contain letters, numbers, underscores, and hyphens.');
    });
    it("should throw when component does not exist", () => {
        expect(() => validateToolAssociation("missing-component", "valid-tool", false, true)).toThrow("Component missing-component not found in registry");
    });
    it("should throw when tool does not exist", () => {
        expect(() => validateToolAssociation("valid-component", "missing-tool", true, false)).toThrow("Tool missing-tool not found in registry");
    });
    it("should throw when both component and tool do not exist", () => {
        expect(() => {
            validateToolAssociation("missing-component", "missing-tool", false, false);
    ...
    it("should validate with valid names containing underscores and hyphens", () => {
        expect(() => validateToolAssociation("my_component-123", "my_tool-456", true, true)).not.toThrow();
    });
});
