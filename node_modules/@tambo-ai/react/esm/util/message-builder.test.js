...
describe("buildMessageContent", () => {
    ...
    describe("resource content resolution", () => {
        it("should include text content from resolved resource", () => {
            ...
            const result = buildMessageContent("Check @registry:file:///doc.txt", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "text",
                    text: "Check ",
        ...
        it("should include blob content from resolved resource", () => {
            ...
            const result = buildMessageContent("Check @registry:file:///image.png", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "text",
                    text: "Check ",
        ...
        it("should include name and resolved content together", () => {
            ...
            const result = buildMessageContent("@registry:file:///doc.txt", [], resourceNames, resourceContent);
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should handle multiple resources with mixed resolved content", () => {
            ...
            const result = buildMessageContent("@registry:file:///doc1.txt and @tambo-abc:tambo://doc2", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should handle resolved content without mimeType", () => {
            ...
            const result = buildMessageContent("@server:file:///doc.txt", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should handle empty resourceContent map gracefully", () => {
            const result = buildMessageContent("@registry:file:///doc.txt", [], {}, new Map());
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should handle undefined resourceContent gracefully", () => {
            const result = buildMessageContent("@registry:file:///doc.txt", [], {}, undefined);
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should handle resolved content with empty contents array", () => {
            ...
            const result = buildMessageContent("@registry:file:///doc.txt", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "resource",
                    resource: {
        ...
        it("should include resolved content with MCP server resources", () => {
            ...
            const result = buildMessageContent("Check issue @linear:linear://issue/123", [], {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "text",
                    text: "Check issue ",
        ...
        it("should combine resolved content with images", () => {
            ...
            const result = buildMessageContent("Check @registry:file:///doc.txt", images, {}, resourceContent);
            expect(result).toEqual([
                {
                    type: "text",
                    text: "Check ",
