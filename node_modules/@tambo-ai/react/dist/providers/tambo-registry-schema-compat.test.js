    ...
    describe("registerTool with different schema types", () => {
        describe("Deprecated toolSchema throws error", () => {
            ...
            it("should throw error when using deprecated toolSchema", () => {
                const { result } = (0, react_1.renderHook)(() => (0, tambo_registry_provider_1.useTamboRegistry)(), { wrapper });
                expect(() => {
                    (0, react_1.act)(() => result.current.registerTool(deprecatedTool));
                }).toThrow('Tool "deprecated-tool" uses deprecated "toolSchema" property.');
            });
            it("registerTools should throw error when using deprecated toolSchema", () => {
                const { result } = (0, react_1.renderHook)(() => (0, tambo_registry_provider_1.useTamboRegistry)(), { wrapper });
                expect(() => {
                    (0, react_1.act)(() => result.current.registerTools([deprecatedTool]));
                }).toThrow('Tool "deprecated-tool" uses deprecated "toolSchema" property.');
            });
        });
