...
exports.toAvailableComponent = toAvailableComponent;
exports.toAvailableComponents = toAvailableComponents;
exports.toAvailableTool = toAvailableTool;
exports.toAvailableTools = toAvailableTools;
...
function toAvailableTool(tool) {
    ...
    if ("inputSchema" in tool && tool.inputSchema) {
        const inputSchema = (0, schema_1.schemaToJsonSchema)(tool.inputSchema);
        return {
            name: tool.name,
    ...
    if ("toolSchema" in tool && tool.toolSchema) {
        const inputSchema = (0, schema_1.schemaToJsonSchema)(tool.toolSchema);
        return {
            name: tool.name,
            description: tool.description,
            inputSchema: inputSchema,
