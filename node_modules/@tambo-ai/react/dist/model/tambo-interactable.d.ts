...
export interface TamboInteractableComponent<Props = Record<string, unknown>, State = Record<string, unknown>> extends TamboComponent {
...
export interface TamboInteractableContext {
    ...
    getInteractableComponent: <P = Record<string, unknown>, S = Record<string, unknown>>(id: string) => TamboInteractableComponent<P, S> | undefined;
