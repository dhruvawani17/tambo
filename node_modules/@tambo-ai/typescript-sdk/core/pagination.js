...
exports.OffsetAndLimit = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.TamboAIError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
