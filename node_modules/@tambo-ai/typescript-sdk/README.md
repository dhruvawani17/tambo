...
[![NPM version](<https://img.shields.io/npm/v/@tambo-ai/typescript-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@tambo-ai/typescript-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@tambo-ai/typescript-sdk)
...
1. Via the `TAMBO_AI_LOG` environment variable
...
const client = new TamboAI({
  logger: logger.child({ name: 'TamboAI' }),
...
const client = new TamboAI({ fetch });
```
...
```ts
import TamboAI from 'npm:@tambo-ai/typescript-sdk';
