...
const storage_1 = require("./resources/storage.js");
const beta_1 = require("./resources/beta/beta.js");
const threads_1 = require("./resources/threads/threads.js");
...
class TamboAI {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('TAMBO_AI_BASE_URL'), apiKey = (0, env_1.readEnv)('TAMBO_API_KEY') ?? null, bearer = null, ...opts } = {}) {
        _TamboAI_instances.add(this);
        _TamboAI_encoder.set(this, void 0);
        this.beta = new API.Beta(this);
        this.storage = new API.Storage(this);
        this.threads = new API.Threads(this);
        const options = {
            apiKey,
            bearer,
            ...opts,
        ...
        if (baseURL && opts.environment) {
            throw new Errors.TamboAIError('Ambiguous URL; The `baseURL` option (or TAMBO_AI_BASE_URL env var) and the `environment` option are given. If you want to use the environment you must pass baseURL: null');
        }
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('TAMBO_AI_LOG'), "process.env['TAMBO_AI_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 0;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _TamboAI_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.TamboAIError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _TamboAI_instances, "m", _TamboAI_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _TamboAI_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.TamboAI = TamboAI;
...
TamboAI.TamboAIError = Errors.TamboAIError;
TamboAI.APIError = Errors.APIError;
TamboAI.APIConnectionError = Errors.APIConnectionError;
TamboAI.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
TamboAI.APIUserAbortError = Errors.APIUserAbortError;
TamboAI.NotFoundError = Errors.NotFoundError;
TamboAI.ConflictError = Errors.ConflictError;
TamboAI.RateLimitError = Errors.RateLimitError;
TamboAI.BadRequestError = Errors.BadRequestError;
TamboAI.AuthenticationError = Errors.AuthenticationError;
TamboAI.InternalServerError = Errors.InternalServerError;
TamboAI.PermissionDeniedError = Errors.PermissionDeniedError;
TamboAI.UnprocessableEntityError = Errors.UnprocessableEntityError;
TamboAI.toFile = Uploads.toFile;
TamboAI.Beta = beta_1.Beta;
TamboAI.Storage = storage_1.Storage;
TamboAI.Threads = threads_1.Threads;
