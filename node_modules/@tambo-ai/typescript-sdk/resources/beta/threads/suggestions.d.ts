...
export declare class Suggestions extends APIResource {
     ...
     * ```
     */
    generate(messageID: string, params: SuggestionGenerateParams, options?: RequestOptions): APIPromise<SuggestionGenerateResponse>;
}
