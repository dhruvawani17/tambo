...
import type { TamboAI } from "../client.mjs";
 ...
 */
export declare const maybeMultipartFormRequestOptions: (opts: RequestOptions, fetch: TamboAI | Fetch) => Promise<RequestOptions>;
type MultipartFormRequestOptions = Omit<RequestOptions, 'body'> & {
    body: unknown;
};
export declare const multipartFormRequestOptions: (opts: MultipartFormRequestOptions, fetch: TamboAI | Fetch) => Promise<RequestOptions>;
export declare const createForm: <T = Record<string, unknown>>(body: T | undefined, fetch: TamboAI | Fetch) => Promise<FormData>;
export {};
